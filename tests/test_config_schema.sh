...
write valid '{"schemaVersion":2,"global":{"defaultAccountEmail":"ops@example.org","testMode":true,"coreTag":"v3.1.4","acmeHome":"/etc/acme"},"accountProfiles":[{"id":"acc","name":"LE","ca":"letsencrypt","accountEmail":""}],"issueProfiles":[{"id":"issue","name":"Example","domain":"example.org","accountProfileId":"acc","deployProfileId":"deploy","keyType":"ec256","validationMethod":"dns","testModeOverride":"inherit-global-test-mode","dnsApi":"dns_cf","credentialMode":"token","credentials":{"CF_Token":"secret"}}],"deployProfiles":[{"id":"deploy","name":"nginx","type":"ssh","certSource":"managed-acme","domain":"example.org","keyType":"ec256","host":"192.0.2.10","user":"root","port":"22","sshKey":"/root/.ssh/id_ed25519","keyFile":"/etc/ssl/example.key","fullchainFile":"/etc/ssl/example.pem","reloadcmd":"service nginx reload"}]}'
accept valid

write nested-types '{"schemaVersion":2,"global":[],"accountProfiles":{},"issueProfiles":[],"deployProfiles":[]}'
reject nested-types
write unknown '{"schemaVersion":2,"global":{"defaultAccountEmail":"ops@example.org","testMode":true,"coreTag":"v3.1.4","acmeHome":"/etc/acme"},"accountProfiles":[],"issueProfiles":[],"deployProfiles":[],"surprise":true}'
reject unknown
write duplicate '{"schemaVersion":2,"global":{"defaultAccountEmail":"ops@example.org","testMode":true,"coreTag":"v3.1.4","acmeHome":"/etc/acme"},"accountProfiles":[{"id":"same","name":"a","ca":"letsencrypt","accountEmail":""},{"id":"same","name":"b","ca":"letsencrypt","accountEmail":""}],"issueProfiles":[],"deployProfiles":[]}'
reject duplicate
...
printf '%s\n' '{"schemaVersion":2,"global":{"defaultAccountEmail":"ops@example.org","testMode":true,"coreTag":"v3.1.4","acmeHome":"/etc/acme"},"accountProfiles":[{"id":"acc","name":"LE","ca":"letsencrypt","accountEmail":""}],"issueProfiles":[{"id":"issue","name":"Example","domain":"example.org","accountProfileId":"acc","deployProfileId":"","keyType":"ec256","validationMethod":"dns","testModeOverride":"inherit-global-test-mode","dnsApi":"dns_cf","credentialMode":"token","credentials":{"CF_Token":"line1\\nline2"}}],"deployProfiles":[]}' > "$TMP/multiline-credential.json"; reject multiline-credential
...
sed 's/"validationMethod":"dns","testModeOverride":"inherit-global-test-mode","dnsApi":"dns_cf","credentialMode":"token","credentials":{"CF_Token":"secret"}/"validationMethod":"webroot","testModeOverride":"inherit-global-test-mode","webroot":"relative"/' "$TMP/valid.json" > "$TMP/relative-webroot.json"; reject relative-webroot
sed 's/"validationMethod":"dns","testModeOverride":"inherit-global-test-mode","dnsApi":"dns_cf","credentialMode":"token","credentials":{"CF_Token":"secret"}/"validationMethod":"standalone","testModeOverride":"inherit-global-test-mode","listenPort":"65536"/' "$TMP/valid.json" > "$TMP/bad-listen-port.json"; reject bad-listen-port
