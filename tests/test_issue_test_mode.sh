...
custom="$(sh "$ROOT/root/usr/libexec/acmesh-console/acmeshctl" issue --domain custom.example.com --key-type ec256 --dns-api dns_custom --credential ODD_VARIABLE=custom-secret --test-mode)"
