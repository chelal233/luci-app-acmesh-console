...
English summary: A security-first LuCI console for operating the official `acme.sh` client on OpenWrt and ImmortalWrt, with explicit risk authorization, protected secrets, SSH host-key pinning, transactional deployment and auditable background tasks.
